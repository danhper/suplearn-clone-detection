...
predict([
    ...
    ("./tmp/Hanoi.java", "./tmp/hanoi.py"),
    ("./tmp/FizzBuzz.java", "./tmp/fizzbuzz.py"),
    ("./tmp/KnuthShuffle.java", "./tmp/knuth_shuffle.py"),

    ("./tmp/Fibo.java", "./tmp/fact.py"),
    ("./tmp/Fact.java", "./tmp/fibo.py"),
    ("./tmp/Fact.java", "./tmp/quicksort.py"),
    ("./tmp/Fact.java", "./tmp/fizzbuzz.py"),
    ("./tmp/Quicksort.java", "./tmp/fibo.py"),
    ("./tmp/Fibo.java", "./tmp/quicksort.py"),
    ("./tmp/Fibo.java", "./tmp/hanoi.py"),
    ("./tmp/Hanoi.java", "./tmp/fibo.py"),
    ("./tmp/Quicksort.java", "./tmp/hanoi.py"),
    ("./tmp/Comb.java", "./tmp/hanoi.py"),
